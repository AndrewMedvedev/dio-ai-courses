...
from src.courses.domain.services import (
    assert_reorder_matches_blocks,
    assert_reorder_matches_lessons,
)
from src.courses.infra.models import Block, Lesson, Practice
from src.courses.infra.queries import active_practice, must_get_course
from src.courses.mappers import map_block_to_domain, map_course_to_domain
...
from src.courses.services.course import serialize_course
