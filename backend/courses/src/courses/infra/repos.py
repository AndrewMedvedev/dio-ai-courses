...
from src.courses.infra.queries import course_query, create_block_nested
from src.courses.schemas import CourseCreate, CourseListItem, CourseListOut, NestedBlockCreate
